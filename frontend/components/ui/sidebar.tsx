...
//add active prop to SidebarMenuItem
const SidebarMenuItem = React.forwardRef<HTMLLIElement, React.ComponentProps<"li"> & { active?: boolean }>(
  ({ className, active = false, ...props }, ref) => (
    <li
      ref={ref}
      data-sidebar="menu-item"
      data-active={active}
      className={cn("group/menu-item relative", active ? "bg-gray-300" : "", className)}
      {...props}
    />
  ),
)
